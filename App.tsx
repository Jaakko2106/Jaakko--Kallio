    ...
    return (
        <>
            ...
            <OffCanvasMenu 
                ...
                activeSection={activeSection}
            />
            <div id="overlay" className={`overlay fixed inset-0 z-[55] ${isMenuOpen ? 'open' : ''}`} onClick={handleMenuClose} aria-hidden="true"></div>

            <main className="bg-white dark:bg-gray-900 transition-colors duration-500 ease-in-out">
                <HomeSection />
                <AboutSection />
                <ExperienceSection />
                <EducationSection />
